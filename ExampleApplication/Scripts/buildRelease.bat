...
set final_build_dir="%cd%\Build\Release\ExampleApplication.exe"
...
set additional_libs=kernel32.lib user32.lib libucrt.lib libvcruntime.lib libcmt.lib cstdd.lib elixird.lib
...
set link_op=/link /OUT:%final_build_dir% %additional_libs% /DEBUG /MACHINE:X64 /NODEFAULTLIB /CGTHREADS:4 /NOLOGO /SUBSYSTEM:WINDOWS /GUARD:NO /STACK:0x400000,0x400000 /MANIFEST:NO /LTCG /CLRUNMANAGEDCODECHECK:NO /CLRSUPPORTLASTERROR:NO /GUARD:NO /DYNAMICBASE:NO /OPT:REF /OPT:ICF %additional_lib_paths%
